...
import mvcani.model.BoardDAO;
import mvcani.model.BoardDTO;
...
public class BoardController extends HttpServlet {
	...
	// 새로운 글 등록하기
	  ...
	  BoardDTO board = new BoardDTO(); 
		/* board.setId(request.getParameter("num")); */
	  ...
	  board.setAge(Integer.parseInt(request.getParameter("aniage")));
		...
		/*
		 * System.out.println(request.getParameter("aniid"));
		 * System.out.println(request.getParameter("aniname"));
		 * System.out.println(request.getParameter("aniage"));
