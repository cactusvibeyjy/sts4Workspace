	...
	<div class="container">
		...
		<div>
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link" href="<c:url value="/Animalproducts.jsp"/>"> 동물 목록</a></li>
				...
				<li class="nav-item"><a class="nav-link" href="<c:url value="/editAnimal.jsp?edit=update"/>">동물 수정</a></li>
				<li class="nav-item"><a class="nav-link" href="<c:url value="/editAnimal.jsp?edit=delete"/>">동물 삭제</a></li>
				<li class="nav-item"><a class="nav-link" href="<c:url value="/BoardListAction.do?pageNum=1"/>">게시판</a></li>
				<li class="nav-item"><a class="nav-link" href="<c:url value="/BoardListAction.do?pageNum=1"/>">동물게시판</a></li>
			</ul>
		</div>
	</div>
</nav>
