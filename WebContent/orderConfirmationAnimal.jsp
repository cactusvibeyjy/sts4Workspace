...
<body>
	...
	<div class="container col-8 alert alert-info">
		...
		<div>
			...
			%>
			<tr>
				<td class="text-center"><em><%=animal.getA_name()%> </em></td>
				<td class="text-center"><%=animal.getQuantity()%></td>
				<td class="text-center"><%=testPrice%>원</td>
			...
			<tr>
				...
				<a href="./ShippingInfoAnimal.jsp?a_name=<%=shipping_cartId%>"class="btn btn-secondary" role="button"> 이전 </a>
