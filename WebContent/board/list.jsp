...
<%
	...
	List boardList = (List) request.getAttribute("boardlist");// boardlist => 변수이름
...
<body>
	...
	<h3>total_record : <%=total_record %></h3>
	<h3>pageNum : <%=pageNum %></h3>
	<h3>total_pageNum : <%=total_page %></h3>
	<h3>RequestURI : <%=RequestURI %></h3>
